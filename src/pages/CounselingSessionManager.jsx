...
import {
  ...
  IconButton, TextField, Snackbar, Alert, Typography, Autocomplete
} from '@mui/material';
import { DataGrid } from '@mui/x-data-grid';
import { Add, Delete, Edit, Close as CloseIcon } from '@mui/icons-material';
...
const CounselingSessionManager = () => {
  ...
  const columns = [
    ...
    { field: 'notes', headerName: 'Notes', flex: 2 },
    {
      ...
      renderCell: (params) => (
        <>
          <IconButton onClick={() => handleOpenDialog(params.row)}><Edit /></IconButton>
